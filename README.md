...
This tool is designed with OWASP and NIST SP 800-53 security controls. See [ARCHITECTURE.md](ARCHITECTURE.md) for the full security model, threat analysis, and input validation specifications.
